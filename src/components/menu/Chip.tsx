...
import { DataNav, Responsive } from "../../type/type";
...
const Chip = (props: ChipProps) => {
    ...
    const accessMenu = () => {
        if (!isLocate(path, props.data)) {
            addClassName(["hide_in_top"], props.toggle ? ".factory_header" : ".origin_header")
            removeClassName(["hide_in_top"], props.toggle ? ".origin_header" : ".factory_header");
        }
